...
version (XBYAK64)
{
    ...
    class Code : TestCode
    {
        this(string name)
        {
            ...
            tilemovcol(tmm1, zmm0, eax); sdump("62F2FD484BC8");
            tilemovcol(tmm2, zmm8, r8d); sdump("62D2BD484BD0");
            tilemovcol(tmm3, zmm16, r16d); sdump("62B2FD404BD8");
            tilemovcol(tmm4, zmm24, r24d); sdump("6292BD404BE0");
            tilemovcol(tmm1, zmm0, r24d); sdump("62F2BD404BC8");
            tilemovcol(tmm2, zmm8, r16d); sdump("62D2FD404BD0");
            tilemovcol(tmm3, zmm16, r8d); sdump("62B2BD484BD8");
            tilemovcol(tmm4, zmm24, eax); sdump("6292FD484BE0");
            tilemovcol(tmm1, zmm0, 0x00); sdump("62F3FD482FC800");
            tilemovcol(tmm2, zmm8, 0x12); sdump("62D3FD482FD012");
            tilemovcol(tmm3, zmm16, 0x2D); sdump("62B3FD482FD82D");
            tilemovcol(tmm4, zmm24, 0x3F); sdump("6293FD482FE03F");

            tilemovrow(tmm1, zmm0, eax); sdump("62F2FD484AC8");
            tilemovrow(tmm2, zmm8, r8d); sdump("62D2BD484AD0");
            tilemovrow(tmm3, zmm16, r16d); sdump("62B2FD404AD8");
            tilemovrow(tmm4, zmm24, r24d); sdump("6292BD404AE0");
            tilemovrow(tmm1, zmm0, r24d); sdump("62F2BD404AC8");
            tilemovrow(tmm2, zmm8, r16d); sdump("62D2FD404AD0");
            tilemovrow(tmm3, zmm16, r8d); sdump("62B2BD484AD8");
            tilemovrow(tmm4, zmm24, eax); sdump("6292FD484AE0");
            tilemovrow(tmm1, zmm0, 0x00); sdump("62F3FD4807C800");
            tilemovrow(tmm2, zmm8, 0x12); sdump("62D3FD4807D012");
            tilemovrow(tmm3, zmm16, 0x2D); sdump("62B3FD4807D82D");
            tilemovrow(tmm4, zmm24, 0x3F); sdump("6293FD4807E03F");

            top2bf16ps(tmm1, zmm0, zmm0); sdump("62F27E485CC8");
            top2bf16ps(tmm2, zmm8, zmm8); sdump("62D23E485CD0");
            top2bf16ps(tmm3, zmm16, zmm16); sdump("62B27E405CD8");
            top2bf16ps(tmm4, zmm24, zmm24); sdump("62923E405CE0");
            top2bf16ps(tmm1, zmm0, zmm24); sdump("62F23E405CC8");
            top2bf16ps(tmm2, zmm8, zmm16); sdump("62D27E405CD0");
            top2bf16ps(tmm3, zmm16, zmm8); sdump("62B23E485CD8");
            top2bf16ps(tmm4, zmm24, zmm0); sdump("62927E485CE0");

            top4bssd(tmm1, zmm0, zmm0); sdump("62F27F485EC8");
            top4bssd(tmm2, zmm8, zmm8); sdump("62D23F485ED0");
            top4bssd(tmm3, zmm16, zmm16); sdump("62B27F405ED8");
            top4bssd(tmm4, zmm24, zmm24); sdump("62923F405EE0");
            top4bssd(tmm1, zmm0, zmm24); sdump("62F23F405EC8");
            top4bssd(tmm2, zmm8, zmm16); sdump("62D27F405ED0");
            top4bssd(tmm3, zmm16, zmm8); sdump("62B23F485ED8");
            top4bssd(tmm4, zmm24, zmm0); sdump("62927F485EE0");

            top4bsud(tmm1, zmm0, zmm0); sdump("62F27E485EC8");
            top4bsud(tmm2, zmm8, zmm8); sdump("62D23E485ED0");
            top4bsud(tmm3, zmm16, zmm16); sdump("62B27E405ED8");
            top4bsud(tmm4, zmm24, zmm24); sdump("62923E405EE0");
            top4bsud(tmm1, zmm0, zmm24); sdump("62F23E405EC8");
            top4bsud(tmm2, zmm8, zmm16); sdump("62D27E405ED0");
            top4bsud(tmm3, zmm16, zmm8); sdump("62B23E485ED8");
            top4bsud(tmm4, zmm24, zmm0); sdump("62927E485EE0");

            top4busd(tmm1, zmm0, zmm0); sdump("62F27D485EC8");
            top4busd(tmm2, zmm8, zmm8); sdump("62D23D485ED0");
            top4busd(tmm3, zmm16, zmm16); sdump("62B27D405ED8");
            top4busd(tmm4, zmm24, zmm24); sdump("62923D405EE0");
            top4busd(tmm1, zmm0, zmm24); sdump("62F23D405EC8");
            top4busd(tmm2, zmm8, zmm16); sdump("62D27D405ED0");
            top4busd(tmm3, zmm16, zmm8); sdump("62B23D485ED8");
            top4busd(tmm4, zmm24, zmm0); sdump("62927D485EE0");

            top4buud(tmm1, zmm0, zmm0); sdump("62F27C485EC8");
            top4buud(tmm2, zmm8, zmm8); sdump("62D23C485ED0");
            top4buud(tmm3, zmm16, zmm16); sdump("62B27C405ED8");
            top4buud(tmm4, zmm24, zmm24); sdump("62923C405EE0");
            top4buud(tmm1, zmm0, zmm24); sdump("62F23C405EC8");
            top4buud(tmm2, zmm8, zmm16); sdump("62D27C405ED0");
            top4buud(tmm3, zmm16, zmm8); sdump("62B23C485ED8");
            top4buud(tmm4, zmm24, zmm0); sdump("62927C485EE0");

            top4mxbf8ps(tmm1, zmm0, zmm0, 0x00); sdump("62F37C488DC800");
            top4mxbf8ps(tmm2, zmm8, zmm8, 0x12); sdump("62D33C488DD012");
            top4mxbf8ps(tmm3, zmm16, zmm16, 0x2D); sdump("62B37C408DD82D");
            top4mxbf8ps(tmm4, zmm24, zmm24, 0x3F); sdump("62933C408DE03F");
            top4mxbf8ps(tmm1, zmm0, zmm24, 0x3F); sdump("62F33C408DC83F");
            top4mxbf8ps(tmm2, zmm8, zmm16, 0x2D); sdump("62D37C408DD02D");
            top4mxbf8ps(tmm3, zmm16, zmm8, 0x12); sdump("62B33C488DD812");
            top4mxbf8ps(tmm4, zmm24, zmm0, 0x00); sdump("62937C488DE000");

            top4mxbhf8ps(tmm1, zmm0, zmm0, 0x00); sdump("62F37F488DC800");
            top4mxbhf8ps(tmm2, zmm8, zmm8, 0x12); sdump("62D33F488DD012");
            top4mxbhf8ps(tmm3, zmm16, zmm16, 0x2D); sdump("62B37F408DD82D");
            top4mxbhf8ps(tmm4, zmm24, zmm24, 0x3F); sdump("62933F408DE03F");
            top4mxbhf8ps(tmm1, zmm0, zmm24, 0x3F); sdump("62F33F408DC83F");
            top4mxbhf8ps(tmm2, zmm8, zmm16, 0x2D); sdump("62D37F408DD02D");
            top4mxbhf8ps(tmm3, zmm16, zmm8, 0x12); sdump("62B33F488DD812");
            top4mxbhf8ps(tmm4, zmm24, zmm0, 0x00); sdump("62937F488DE000");

            top4mxhbf8ps(tmm1, zmm0, zmm0, 0x00); sdump("62F37E488DC800");
            top4mxhbf8ps(tmm2, zmm8, zmm8, 0x12); sdump("62D33E488DD012");
            top4mxhbf8ps(tmm3, zmm16, zmm16, 0x2D); sdump("62B37E408DD82D");
            top4mxhbf8ps(tmm4, zmm24, zmm24, 0x3F); sdump("62933E408DE03F");
            top4mxhbf8ps(tmm1, zmm0, zmm24, 0x3F); sdump("62F33E408DC83F");
            top4mxhbf8ps(tmm2, zmm8, zmm16, 0x2D); sdump("62D37E408DD02D");
            top4mxhbf8ps(tmm3, zmm16, zmm8, 0x12); sdump("62B33E488DD812");
            top4mxhbf8ps(tmm4, zmm24, zmm0, 0x00); sdump("62937E488DE000");

            top4mxhf8ps(tmm1, zmm0, zmm0, 0x00); sdump("62F37D488DC800");
            top4mxhf8ps(tmm2, zmm8, zmm8, 0x12); sdump("62D33D488DD012");
            top4mxhf8ps(tmm3, zmm16, zmm16, 0x2D); sdump("62B37D408DD82D");
            top4mxhf8ps(tmm4, zmm24, zmm24, 0x3F); sdump("62933D408DE03F");
            top4mxhf8ps(tmm1, zmm0, zmm24, 0x3F); sdump("62F33D408DC83F");
            top4mxhf8ps(tmm2, zmm8, zmm16, 0x2D); sdump("62D37D408DD02D");
            top4mxhf8ps(tmm3, zmm16, zmm8, 0x12); sdump("62B33D488DD812");
            top4mxhf8ps(tmm4, zmm24, zmm0, 0x00); sdump("62937D488DE000");

            top4mxbssps(tmm1, zmm0, zmm0, 0x00); sdump("62F37F488FC800");
            top4mxbssps(tmm2, zmm8, zmm8, 0x12); sdump("62D33F488FD012");
            top4mxbssps(tmm3, zmm16, zmm16, 0x2D); sdump("62B37F408FD82D");
            top4mxbssps(tmm4, zmm24, zmm24, 0x3F); sdump("62933F408FE03F");
            top4mxbssps(tmm1, zmm0, zmm24, 0x3F); sdump("62F33F408FC83F");
            top4mxbssps(tmm2, zmm8, zmm16, 0x2D); sdump("62D37F408FD02D");
            top4mxbssps(tmm3, zmm16, zmm8, 0x12); sdump("62B33F488FD812");
            top4mxbssps(tmm4, zmm24, zmm0, 0x00); sdump("62937F488FE000");

            // vcvtps2bf8: opCvt5 shape, dst always xm, src grows xm/ym/zm
            vcvtps2bf8(xm0, xm0); sdump("62F57E0839C0");
            vcvtps2bf8(xm8, xm8); sdump("62557E0839C0");
            vcvtps2bf8(xm16, xm16); sdump("62A57E0839C0");
            vcvtps2bf8(xm24, xm24); sdump("62057E0839C0");
            vcvtps2bf8(xm0, xm24); sdump("62957E0839C0");
            vcvtps2bf8(xm8, xm16); sdump("62357E0839C0");
            vcvtps2bf8(xm16, xm8); sdump("62C57E0839C0");
            vcvtps2bf8(xm24, xm0); sdump("62657E0839C0");
            vcvtps2bf8(xm0, ym0); sdump("62F57E2839C0");
            vcvtps2bf8(xm8, ym8); sdump("62557E2839C0");
            vcvtps2bf8(xm16, ym16); sdump("62A57E2839C0");
            vcvtps2bf8(xm24, ym24); sdump("62057E2839C0");
            vcvtps2bf8(xm0, ym24); sdump("62957E2839C0");
            vcvtps2bf8(xm8, ym16); sdump("62357E2839C0");
            vcvtps2bf8(xm16, ym8); sdump("62C57E2839C0");
            vcvtps2bf8(xm24, ym0); sdump("62657E2839C0");
            vcvtps2bf8(xm0, zm0); sdump("62F57E4839C0");
            vcvtps2bf8(xm8, zm8); sdump("62557E4839C0");
            vcvtps2bf8(xm16, zm16); sdump("62A57E4839C0");
            vcvtps2bf8(xm24, zm24); sdump("62057E4839C0");
            vcvtps2bf8(xm0, zm24); sdump("62957E4839C0");
            vcvtps2bf8(xm8, zm16); sdump("62357E4839C0");
            vcvtps2bf8(xm16, zm8); sdump("62C57E4839C0");
            vcvtps2bf8(xm24, zm0); sdump("62657E4839C0");
            vcvtps2bf8(xm0, xword [rax+rcx*1+0x10]); sdump("62F57E0839440801");
            vcvtps2bf8(xm8, yword [r8+r9*2+0x20]); sdump("62157E2839444801");
            vcvtps2bf8(xm16, zword [r16+r17*4+0x40]); sdump("62ED7A4839448801");
            vcvtps2bf8(xm24, zword [r24+r25*8+0x7f]); sdump("620D7A483984C87F000000");
            vcvtps2bf8(xm0, xword_b [rax+rcx*1+0x10]); sdump("62F57E1839440804");
            vcvtps2bf8(xm8, yword_b [r8+r9*2+0x20]); sdump("62157E3839444808");
            vcvtps2bf8(xm16, zword_b [r16+r17*4+0x40]); sdump("62ED7A5839448810");
            vcvtps2bf8(xm0|k4|T_z, xword [rax+rcx*1+0x10]); sdump("62F57E8C39440801");
            vcvtps2bf8(xm8|k5, zword_b [r8+r9*2+0x40]); sdump("62157E5D39444810");
            vcvtps2bf8(xm0|k4, xm8); sdump("62D57E0C39C0");
            vcvtps2bf8(xm8|k5, xm16); sdump("62357E0D39C0");
            vcvtps2bf8(xm16|k6, xm24); sdump("62857E0E39C0");
            vcvtps2bf8(xm24|k7|T_z, xm0); sdump("62657E8F39C0");
            vcvtps2bf8(xm0|k4, ym8); sdump("62D57E2C39C0");
            vcvtps2bf8(xm8|k5, ym16); sdump("62357E2D39C0");
            vcvtps2bf8(xm16|k6, ym24); sdump("62857E2E39C0");
            vcvtps2bf8(xm24|k7|T_z, ym0); sdump("62657EAF39C0");
            vcvtps2bf8(xm0|k4, zm8); sdump("62D57E4C39C0");
            vcvtps2bf8(xm8|k5, zm16); sdump("62357E4D39C0");
            vcvtps2bf8(xm16|k6, zm24); sdump("62857E4E39C0");
            vcvtps2bf8(xm24|k7|T_z, zm0); sdump("62657ECF39C0");

            // vcvtps2bf8s: opCvt5 shape, dst always xm, src grows xm/ym/zm
            vcvtps2bf8s(xm0, xm0); sdump("62F57E083BC0");
            vcvtps2bf8s(xm8, xm8); sdump("62557E083BC0");
            vcvtps2bf8s(xm16, xm16); sdump("62A57E083BC0");
            vcvtps2bf8s(xm24, xm24); sdump("62057E083BC0");
            vcvtps2bf8s(xm0, xm24); sdump("62957E083BC0");
            vcvtps2bf8s(xm8, xm16); sdump("62357E083BC0");
            vcvtps2bf8s(xm16, xm8); sdump("62C57E083BC0");
            vcvtps2bf8s(xm24, xm0); sdump("62657E083BC0");
            vcvtps2bf8s(xm0, ym0); sdump("62F57E283BC0");
            vcvtps2bf8s(xm8, ym8); sdump("62557E283BC0");
            vcvtps2bf8s(xm16, ym16); sdump("62A57E283BC0");
            vcvtps2bf8s(xm24, ym24); sdump("62057E283BC0");
            vcvtps2bf8s(xm0, ym24); sdump("62957E283BC0");
            vcvtps2bf8s(xm8, ym16); sdump("62357E283BC0");
            vcvtps2bf8s(xm16, ym8); sdump("62C57E283BC0");
            vcvtps2bf8s(xm24, ym0); sdump("62657E283BC0");
            vcvtps2bf8s(xm0, zm0); sdump("62F57E483BC0");
            vcvtps2bf8s(xm8, zm8); sdump("62557E483BC0");
            vcvtps2bf8s(xm16, zm16); sdump("62A57E483BC0");
            vcvtps2bf8s(xm24, zm24); sdump("62057E483BC0");
            vcvtps2bf8s(xm0, zm24); sdump("62957E483BC0");
            vcvtps2bf8s(xm8, zm16); sdump("62357E483BC0");
            vcvtps2bf8s(xm16, zm8); sdump("62C57E483BC0");
            vcvtps2bf8s(xm24, zm0); sdump("62657E483BC0");
            vcvtps2bf8s(xm0, xword [rax+rcx*1+0x10]); sdump("62F57E083B440801");
            vcvtps2bf8s(xm8, yword [r8+r9*2+0x20]); sdump("62157E283B444801");
            vcvtps2bf8s(xm16, zword [r16+r17*4+0x40]); sdump("62ED7A483B448801");
            vcvtps2bf8s(xm24, zword [r24+r25*8+0x7f]); sdump("620D7A483B84C87F000000");
            vcvtps2bf8s(xm0, xword_b [rax+rcx*1+0x10]); sdump("62F57E183B440804");
            vcvtps2bf8s(xm8, yword_b [r8+r9*2+0x20]); sdump("62157E383B444808");
            vcvtps2bf8s(xm16, zword_b [r16+r17*4+0x40]); sdump("62ED7A583B448810");
            vcvtps2bf8s(xm0|k4|T_z, xword [rax+rcx*1+0x10]); sdump("62F57E8C3B440801");
            vcvtps2bf8s(xm8|k5, zword_b [r8+r9*2+0x40]); sdump("62157E5D3B444810");
            vcvtps2bf8s(xm0|k4, xm8); sdump("62D57E0C3BC0");
            vcvtps2bf8s(xm8|k5, xm16); sdump("62357E0D3BC0");
            vcvtps2bf8s(xm16|k6, xm24); sdump("62857E0E3BC0");
            vcvtps2bf8s(xm24|k7|T_z, xm0); sdump("62657E8F3BC0");
            vcvtps2bf8s(xm0|k4, ym8); sdump("62D57E2C3BC0");
            vcvtps2bf8s(xm8|k5, ym16); sdump("62357E2D3BC0");
            vcvtps2bf8s(xm16|k6, ym24); sdump("62857E2E3BC0");
            vcvtps2bf8s(xm24|k7|T_z, ym0); sdump("62657EAF3BC0");
            vcvtps2bf8s(xm0|k4, zm8); sdump("62D57E4C3BC0");
            vcvtps2bf8s(xm8|k5, zm16); sdump("62357E4D3BC0");
            vcvtps2bf8s(xm16|k6, zm24); sdump("62857E4E3BC0");
            vcvtps2bf8s(xm24|k7|T_z, zm0); sdump("62657ECF3BC0");
