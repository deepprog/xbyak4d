module test.address64.address32.gen0110;
...
version (XBYAK64)
{
    ...
    class Gen0110 : TestCode
    {
        this(string name)
        {
            ...
            sdump("67438B8C23E8030000");
            mov(ecx, ptr[r11d + r12d - 1]);
            sdump("67438B4C23FF");
            mov(ecx, ptr[r11d + r12d - 1000]);
            sdump("67438B8C2318FCFFFF");
            ...
            sdump("67418B8C04E8030000");
            mov(ecx, ptr[r12d + eax - 1]);
            sdump("67418B4C04FF");
            mov(ecx, ptr[r12d + eax - 1000]);
            sdump("67418B8C0418FCFFFF");
            ...
            sdump("67418B8C05E8030000");
            mov(ecx, ptr[r13d + eax - 1]);
            sdump("67418B4C05FF");
            mov(ecx, ptr[r13d + eax - 1000]);
            sdump("67418B8C0518FCFFFF");
            ...
            sdump("67418B8C06E8030000");
            mov(ecx, ptr[r14d + eax - 1]);
            sdump("67418B4C06FF");
            mov(ecx, ptr[r14d + eax - 1000]);
            sdump("67418B8C0618FCFFFF");
