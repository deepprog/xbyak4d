...
void badSSE()
{
	class Code : CodeGenerator
	{
		this()
		{
			assertThrown!XError( paddd(xm16, xm1) );
			assertThrown!XError( pslld(xm16, 1) );
			assertThrown!XError( movapd(xm16, xm1) );
			assertThrown!XError( movhpd(xm16, ptr[eax]) );
			assertThrown!XError( pextrb(eax, xm16, 1) );

			assertThrown!XError( lddqu(xm16, ptr[rax]) );
			assertThrown!XError( maskmovdqu(xm16, xm1) );
			assertThrown!XError( maskmovq(xm16, xm1) );
			assertThrown!XError( movapd(ptr[rax], xm16) );
			assertThrown!XError( movaps(ptr[rax], xm16) );
			assertThrown!XError( movd(ptr[rax], xm16) );
			assertThrown!XError( movd(xm16, ptr[rax]) );
			assertThrown!XError( movd(eax, xm16) );
			assertThrown!XError( movd(xm16, eax) );
			assertThrown!XError( movdq2q(mm1, xm16) );
			assertThrown!XError( movdqa(ptr[rax], xm16) );
			assertThrown!XError( movdqu(ptr[rax], xm16) );
			assertThrown!XError( movhlps(xm16, xm1) );
			assertThrown!XError( movlhps(xm16, xm1) );
			assertThrown!XError( movmskpd(rax, xm16) );
			assertThrown!XError( movmskps(rax, xm16) );
			assertThrown!XError( movntdq(ptr[rax], xmm16) );
			assertThrown!XError( movntdqa(xm16, ptr[rax]) );
			assertThrown!XError( movntpd(ptr[rax], xmm16) );
			assertThrown!XError( movntps(ptr[rax], xm16) );
			assertThrown!XError( movntq(ptr[rax], xm16) );
			assertThrown!XError( movq(ptr[rax], xm16) );
			assertThrown!XError( movq(xm16, ptr[rax]) );
			assertThrown!XError( movq(rax, xm16) );
			assertThrown!XError( movq(xm16, rax) );
			assertThrown!XError( movq2dq(xm16, mm1) );
			assertThrown!XError( movsd(ptr[rax], xm16) );
			assertThrown!XError( movss(ptr[rax], xm16) );
			assertThrown!XError( movupd(ptr[rax], xm16) );
			assertThrown!XError( movups(ptr[rax], xm16) );
			assertThrown!XError( extractps(ptr[rax], xm16, 3) );
			assertThrown!XError( pextrb(ptr[rax], xm16, 3) );
			assertThrown!XError( pextrd(ptr[rax], xm16, 3) );
			assertThrown!XError( pextrw(ptr[rax], xm16, 3) );
...
else
{
	...
	foreach (i, tmp; tbl)
	{
		...
		if (tbl[i].error) {
			assertThrown!XError( mov(af[eax], v) );
		} else {
			mov(af[eax], v);
		}
	}
version(XBYAK64)
{
	...
	if ((void*).sizeof != 4) { // sizeof(void*) == 4 on x32
		assertThrown!XError( mov(rax, ptr[cast(void*)0x17fffffff]) );
	}
	...
	{
		if ((void*).sizeof != 4) { // sizeof(void*) == 4 on x32
			assertThrown!XError( mov(rax, ptr[cast(void*)0x80000000UL]) );
			assertThrown!XError( mov(rax, ptr[cast(void*)0xffffffffUL]) );
		}
	}
}
		}
...
void kmask()
{
	class Code : CodeGenerator
	{
		this()
		{
			assertThrown!Exception( kmovb(k1, ax) );
			assertThrown!Exception( kmovw(k1, ax) );
			assertThrown!Exception( kmovd(k1, ax) );
			assertThrown!Exception( kmovq(k1, eax) );
version(XBYAK64)
{
			assertThrown!Exception( kmovb(k1, rax) );
			assertThrown!Exception( kmovw(k1, rax) );
			assertThrown!Exception( kmovd(k1, rax) );
			kmovq(k1, rax);
}
...
void test_gather()
{
	class Code : CodeGenerator
	{
		this()
		{
			...
			assertThrown!Exception(vgatherdpd(xmm1, ptr[eax+xmm1], xmm2) );
			assertThrown!Exception(vgatherdpd(xmm1, ptr[eax+xmm2], xmm1) );
			assertThrown!Exception(vgatherdpd(xmm2, ptr[eax+xmm1], xmm1) );

			vgatherdpd(xmm1|k2, ptr[eax+xmm2]);
			assertThrown!Exception(vgatherdpd(xmm1, ptr[eax+xmm2]) );
			assertThrown!Exception(vgatherdpd(xmm1|k2, ptr[eax+xmm1]) );
...
void vnni()
{
	...
	assertThrown!Exception( c.badVex() );
}
