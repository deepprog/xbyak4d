...
version(XBYAK64)
{
	...
	@("ace_1_fp8_biased_from_ps")
	unittest{
		ace_1_fp8_biased_from_ps();
	}

	void ace_1_fp8_biased_from_ps()
	{
		scope tc = TestCount(__FUNCTION__);
		class Code : CodeGenerator
		{
	...
	@("ace_1_fp6_fp8_reg_only")
	unittest{
		ace_1_fp6_fp8_reg_only();
	}

	void ace_1_fp6_fp8_reg_only()
	{
		scope tc = TestCount(__FUNCTION__);
		class Code : CodeGenerator
		{
